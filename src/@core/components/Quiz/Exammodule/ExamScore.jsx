...
import { getexamsetQuiz, selecttempdata } from "src/store/reducers/tempDataSlice";
                        ...
                        <AnimatedProgressProvider valueStart={0} valueEnd={percentage} duration={0.2} easingFunction={easeQuadInOut}>
                            {(value) => {
                                ...
                                return (
                                    ...
                                    >
                                        <img src={userData.data && userData.data.profile ? userData.data.profile : "/images/user.svg"} alt="user" className="showscore-userprofile" onError={imgError}/>
                                    </CircularProgressbarWithChildren>
                                );
                            }}
