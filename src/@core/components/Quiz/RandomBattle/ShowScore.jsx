                        ...
                        return (
                            <div className="user_data onevsone">
                                <div className="login_winner">
                                    <img src={user1image ? user1image : "/images/user.svg"} alt="user" className="showscore-userprofile" onError={imgError}/>
                                    <p>{user1name}</p>
                                    <p>{t("Winner")}</p>
                                ...
                                <div className="versus_screen">
                                    <img src="/images/battle/vs.svg" alt="versus" />
                                </div>

                                <div className="opponet_loser">
                                    <img src={user2image ? user2image : "/images/user.svg"} alt="user" className="showscore-userprofile" onError={imgError}/>
                                    <p>{user2name}</p>
                                    <p>{t("Loser")}</p>
