...
import AudioQuestionsDashboard from '../../@core/components/Quiz/AudioQuestions/AudioQuestionsDashboard'
import AudioReviewAnswer from '../audio-review-answer'
import { useSelector } from 'react-redux'
import { selecttempdata } from 'src/store/reducers/tempDataSlice'
import { audioquestionsApi, AudioquestionsApi, UserCoinScoreApi } from 'src/store/actions/campaign'
  ...
  const handleReviewAnswers = () => {
    MySwal.fire({
      ...
      text:
        ...
        Number(review_answers_deduct_coin[0].message) + ' ' + t('Coins will be deducted from your account'),
      icon: 'warning',
