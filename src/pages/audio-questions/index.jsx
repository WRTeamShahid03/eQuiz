...
import { categoriesApi, subcategoriesApi } from 'src/store/actions/campaign'
import { Loadtempdata } from 'src/store/reducers/tempDataSlice'
import { useRouter } from 'next/router'
import Breadcrumb from 'src/@core/components/Breadcrumb/Breadcrumb'
import AudioQuestionsSlider from 'src/@core/components/Quiz/AudioQuestions/AudioQuestionsSlider'
...
const AudioQuestions = ({ t }) => {
  ...
  const handleChangeCategory = data => {
    ...
    if (data.no_of != '0') {
      ...
      navigate.push({ pathname: '/audio-questions-play' })
      Loadtempdata(data)
    }
  }
          ...
          <div className='row morphisam mb-5'>
            ...
            <div className='col-xxl-9 col-xl-8 col-lg-8 col-md-12 col-12'>
              <div className='right-sec'>
                <AudioQuestionsSlider
                  data={subCategory.all}
                  selected={subCategory.selected}
                  url={`/audio-questions-play`}
                  Questionsloader={subloading}
                />
              </div>
            </div>
          </div>
