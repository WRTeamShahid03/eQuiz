    ...
    getbookmarkApi(
      ...
      response => {
        const questions = response.data.map(data => {
          ...
          const optionsText = correctAnswers
            ? correctAnswers
                .replace(/<[^>]+>/g, '')
                .replace(/\&nbsp;/g, '')
                .trim()
                          ...
                          <div className='three__stage'>
                            ...
                            <div className='delete__stage'>
                              <button
                                ...
                                onClick={() => quizzonedeleteBookmark(question.question_id, question.id)}
                              >
                                <FaRegTrashAlt />
                              </button>
                            </div>
                  ...
                  {visible < quizzoneQue.length && (
                    <div className='col-md-12 text-center'>
                      <Link
                        href='#'
                        id='load-more'
                        className='btn primary-btn load-more-btn text-white'
                        ...
                        <div className='outer__stage bookmark-box' key={key}>
                          <div className='three__stage'>
                            ...
                            <div className='delete__stage'>
                              <button
                                className='btn btn-primary'
                                onClick={() => guesstheworddeleteBookmark(question.question_id, question.id)}
                              >
                                <FaRegTrashAlt />
                              </button>
                            </div>
                        ...
                        <div className='outer__stage bookmark-box' key={key}>
                          <div className='three__stage'>
                            ...
                            <div className='delete__stage'>
                              <button
                                className='btn btn-primary'
                                onClick={() => AudioquizdeleteBookmark(question.question_id, question.id)}
                              >
                                <FaRegTrashAlt />
                              </button>
                            </div>
                        ...
                        <div className='outer__stage bookmark-box' key={key}>
                          <div className='three__stage'>
                            ...
                            <div className='delete__stage'>
                              <button
                                className='btn btn-primary'
                                onClick={() => mathquizdeleteBookmark(question.question_id, question.id)}
                              >
                                <FaRegTrashAlt />
                              </button>
                            </div>
