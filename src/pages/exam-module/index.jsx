...
const ExamModule = ({ t }) => {
  ...
  const handleSubmit = e => {
    ...
    if (examData && examData == examKeyRef.current.value) {
      if (isChecked) {
        navigate.push('/exam-module-play')
      } else {
          ...
          <div className='row  morphisam mb-5'>
            <div className='col-md-6 col-12'>
              <div className='exam_image'>
                <img src='/images/exam/today.svg' alt='image' />
              </div>
            </div>
      ...
      >
        <div className='custom_checkbox completeDataModal mt-4'>
                ...
                return (
                  <div key={index}>
                    <div className='inner_data'>
                      <p>{t('Obtained Marks')} :</p>{' '}
                      <span className='result_Data'>{data.obtained_marks + '/' + data.total_marks}</span>
                    </div>
                    <div className='inner_data'>
          ...
          <div className='total_questions'>
            {popupCompleteData &&
              popupCompleteData.map((data, index) => {
                return data.statistics.map((elem, index) => {
                  return (
                    <div key={index}>
                      <h6>
                        {elem.mark} {t('Mark Questions')}
                      </h6>
