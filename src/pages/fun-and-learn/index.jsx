...
import { categoriesApi, getfunandlearnApi, subcategoriesApi } from 'src/store/actions/campaign'
import Breadcrumb from 'src/@core/components/Breadcrumb/Breadcrumb'
import FunandLearnSlider from 'src/@core/components/Quiz/Fun_and_Learn/FunandLearnSlider'
import FunandLearnSubCatSlider from 'src/@core/components/Quiz/Fun_and_Learn/FunandLearnSubCatSlider'
import { selectCurrentLanguage } from 'src/store/reducers/languageSlice'
import { excalmationImage } from 'src/utils'
                                ...
                                <li className='d-flex' key={key} onClick={() => handleChangeCategory(data)}>
                                  ...
                                  >
                                    <span className='Box__icon'>
                                      <img src={data.image} alt='image' onError={excalmationImage}/>
                                    </span>
