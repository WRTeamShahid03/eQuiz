                        ...
                        <>
                          <li className='third_data' key={index}>
                            <div className='Leaf_img'>
                              <img
                                className='leftleaf'
                                src='/images/leaderboard/smallleftleaf.svg'
                                alt='leaf'
                              />
                              <img className='data_profile' src={data.profile} alt='third' onError={imgError} />
                              <img
                                className='rightleaf'
                                src='/images/leaderboard/smallrightleaf.svg'
                                alt='leaf'
                              />
                            </div>
                      ...
                      return (
                        <>
                          <li className='first_data' key={index}>
                            <img
                              className='crown'
                              src='/images/leaderboard/crown.svg'
                              alt=''
                            />
                            <div className='Leaf_img'>
                              <img
                                className='leftleaf'
                                src='/images/leaderboard/bigleafleft.svg'
                                alt='leaf'
                              />
                              <img className='data_profile' src={data.profile} alt='first' onError={imgError} />
                              <img
                                className='rightleaf'
                                src='/images/leaderboard/bigrightleaf.svg'
                                alt='leaf'
                              />
                            </div>
                            <h5 className='data_nam'>{data.name}</h5>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className='score all_com'>
                      <strong>{leaderBoard.my_rank.score}</strong>
                    </td>
                  </tr>
                </tbody>
              </table>
