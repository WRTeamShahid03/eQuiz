...
import { excalmationImage, scrollhandler } from '../../utils'
...
import Mathmaniaslider from 'src/@core/components/Quiz/Mathmania/Mathmaniaslider'
...
const MathMania = () => {
  ...
  const handleChangeCategory = data => {
    ...
    if (data.no_of !== '0') {
      ...
      navigate.push({ pathname: '/math-mania-play' })
      Loadtempdata(data)
    }
                                ...
                                <li className='d-flex' key={key} onClick={e => handleChangeCategory(data)}>
                                  ...
                                  >
                                    <span className='Box__icon'>
                                      <img src={data.image} onError={excalmationImage} alt='image' />
                                    </span>
