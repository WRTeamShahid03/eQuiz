...
import { register, updateProfileApi } from "../../store/reducers/userSlice.js";
import Breadcrumb from "../../@core/components/Breadcrumb/Breadcrumb.jsx";
import { imgError } from "../../utils/index.jsx";
import FirebaseData from "../../utils/firebase.js";
import { AiOutlineUsergroupAdd } from "react-icons/ai";
import { Swiper, SwiperSlide } from "swiper/react";
import SwiperCore, { Navigation } from "swiper";
import { profileImages } from "../../assets/json/profileImages.jsx";
                        ...
                        <div className="row morphisam">
                            <div className="col-md-6 col-12">
                                <div className="inner__login__img justify-content-center align-items-center d-flex">
                                    <img src="/images/login/otp_img.svg" alt="otp" />
                                </div>
                            </div>
                                        ...
                                        <form className="form text-start" onSubmit={onSubmit}>
                                            <div>
                                                ...
                                                <div className="send-button">
                                                    ...
                                                    <Link className="btn btn-dark backlogin" href={"/login"} type="button">
                                                        {t("Back to Login")}
                                                    </Link>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-xl-5 col-lg-5 col-md-12 col-12 ">
                                            <div className="row card main__profile d-flex justify-content-center align-items-center">
                                                <div className="prop__image">
                                                    <img src={userData.data && userData.data.profile ? userData.data.profile : "/images/user.svg"} alt="profile" id="user_profile" onError={imgError}/>
