        ...
        <div className='container'>
          <div className='row morphisam'>
            ...
            <div className='col-md-6  col-xl-5 col-xxl-6 col-12'>
              <img
                src='/images/battle/1vs1battle.svg'
                alt='1vs1'
                  ...
                  <div className='inner_content d-flex align-items-center flex-wrap'>
                      ...
                      {coinsdata.map((data, idx) => {
                        return (
                          <li key={idx} className='list-unstyled me-5' onClick={e => selectedCoinsdata(data)}>
                            <button
                              className={`btn btn-primary ${data.num == selectedcoins ? 'active-one' : 'unactive-one'}`}
                            >
                              {data.num}
                            </button>
                            <img src='/images/battle/coin.svg' alt='coin' />
                          </li>
                        )
                      })}
                    </ul>
                    <div className='input_coins'>
                      <input
                        ...
                        placeholder='00'
                        min='0'
                        onChange={e => setSelectedCoins({ ...selectedCoins, selected: e.target.value })}
                        ref={inputText}
                      />
                    </div>
                  </div>
