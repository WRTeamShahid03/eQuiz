                      ...
                      <div className='row'>
                        <div className='col-md-6 col-12'>
                          <div className='bookmark__content common_content'>
                            <Link href='/bookmark' className='w-100 d-block'>
                        ...
                        <div className='col-md-6 col-12'>
                          <div className='Invite_friends__content common_content'>
                            <Link href='/invite-friends' className='w-100 d-block'>
                      ...
                      <div className='row'>
                        <div className='col-md-6 col-12'>
                          <div className='tracker_data common_content'>
                            <Link href='/coin-history' className='w-100 d-block'>
                        ...
                        <div className='col-md-6 col-12'>
                          <div className='badges common_content'>
                            <Link href='/badges' className='w-100 d-block'>
                              <span>{t('Badges')}</span>
                              <i className='custom-icon'>
                      ...
                      <div className='row'>
                        <div className='col-md-6 col-12'>
                          <div className='share_app common_content'>
                            <Link href="" className='w-100 d-block' onClick={e => shareAppButton(e)}>
                            ...
                            >
                              ...
                              <WhatsappShareButton
                                url={`${web_link_footer}`}
                                title={t('checkout our web and enjoy quiz')}
                              >
                        ...
                        <div className='col-md-6 col-12'>
                          <div className='statistics common_content'>
                            <Link href='/statistics' className='w-100 d-block'>
                      ...
                      <div className='row'>
                        <div className='col-md-6 col-12'>
                          <div className='wallet common_content'>
                            <Link href='/wallet' className='w-100 d-block'>
                              <span>{t('Wallet')}</span>
                              <i className='custom-icon'>
                                <IoWalletOutline />
                              </i>
                        ...
                        <div className='col-md-6 col-12'>
                          <div className='Delete_account__content common_content'>
                            <Link href={''} className='w-100 d-block' onClick={deleteAccountClick}>
                        ...
                        <div className='col-md-6 col-12'>
                          <div className='Logout__content common_content'>
                            <Link href={''} onClick={handleSignout} className='w-100 d-block'>
                              <span>{t('Logout')}</span>
                              <i className='custom-icon'>
                                <FaSignOutAlt />
                              </i>
