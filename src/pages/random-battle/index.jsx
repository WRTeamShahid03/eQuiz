...
import Timer from 'src/@core/components/Quiz/common/Timer'
...
const RandomBattle = ({ t }) => {
  ...
  const seconduserfound = () => {
    ...
    navigate.push({ pathname: '/random-play' })
  ...
  const PlaywithFriend = () => {
    navigate.push({ pathname: '/play-with-friend-battle' })
    let data = {
      category_id: category_selected,
