...
import QuestionSlider from 'src/@core/components/Quiz/SelfLearning/QuestionSlider'
import TimerSlider from 'src/@core/components/Quiz/SelfLearning/TimerSlider'
import Questionsdata from 'src/@core/components/Quiz/SelfLearning/Questionsdata'
...
const SelfLearning = ({ t }) => {
  ...
  const handleStart = () => {
    if (!totalquestions.selected) {
      ...
      navigate.push({ pathname: '/self-learning-play' })
      let data = {
