          ...
          <div className='row botton_card_details'>
                ...
                <ul className='quiz_details_inner'>
                  <li>
                    ...
                    <span className='badge badge-pill custom_badge'>
                      {userData.data && userData.data.userProfileStatics.all_time_rank}
                    </span>
                  </li>
                  <li>
                    {t('Score')}
                    <span className='badge badge-pill custom_badge'>
                      {userData.data && userData.data.userProfileStatics.all_time_score}
                    </span>
                  </li>
                  <li>
                    {t('Coins')}
                    <span className='badge badge-pill custom_badge'>
                      {userData.data && userData.data.userProfileStatics.coins}
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className='questions_details morphism'>
                ...
                <ul className='questions_details_inner'>
                  ...
                  <li>
                    ...
                    <span className='badge badge-pill custom_badge'>
                      {userData.data &&
                        (userData.data.userStatics.correct_answers ? userData.data.userStatics.correct_answers : '0')}
                    </span>
                  </li>
                  <li>
                    {t('Incorrect')}
                  ...
                  {battleStatisticsResult.map((elem, _index) => {
                    return (
                      <>
                        <li>
                          {t('Draw')}
                          <span className='badge badge-pill custom_badge'>{elem.Drawn}</span>
                        </li>
                        <li>
                          {t('Won')}
                          <span className='badge badge-pill custom_badge'>{elem.Victories}</span>
                        </li>
                        <li>
                          {t('Lost')}
                          <span className='badge badge-pill custom_badge'>{elem.Loose}</span>
                        </li>
                      </>
                    )
                  })}
            ...
            <div className='col-md-6 col-12 pe-0'>
              <div className='questions_details morphism badges battle_statistics_badges '>
                <Link href={'/badges'} className='questions_details_title statistics_badges'>
                  {t('Collected Badges')} <p className='mb-0 view_all'>{t('View All')}</p>
                </Link>
