...
import { UserCoinScoreApi, getPaymentApi, getusercoinsApi, setPaymentApi } from 'src/store/actions/campaign'
...
const Wallet = () => {
  ...
  return (
    <>
          ...
          <div className='row morphisam'>
            <div className='col-md-6 col-12'>
              <div className='image mb-4'>
                <img src='/images/wallet/paymentrequest.svg' alt='wallet' />
              </div>
            </div>
            <div className='col-md-6 col-12'>
      ...
      >
        <h4>
          {t('Redeemable Amount')} ${redeemInput}
        </h4>
        <p>
        ...
        <ul className='payment_icon ps-0'>
          <li>
            <i onClick={e => paymentModal(e, 'paypal')}>
              <RiPaypalFill />
            </i>
          </li>
          <li>
            <i onClick={e => paymentModal(e, 'paytm')}>
              <SiPaytm />
            </i>
          </li>
          <li>
            <i onClick={e => paymentModal(e, 'stripe')}>
              <FaStripe />
            </i>
          </li>
        </ul>
